<template>
  <article>
    <div @click="close" class="shade" :class="{ show: this.panel.modal.name == 'sidebar' && this.panel.modal.show }"></div>
    <div class="sidebar-academy" :class="{ show: this.panel.modal.name == 'sidebar' && this.panel.modal.show }">
      <header>
        <a href="/epanel" class="logo">
          <span style="display: flex; align-items: center; width: 100px; color: #fff;">
      ...
      <div class="body">
        <ul @click="close" class="menu">
          <div>EXPLORAR</div>
          <li class="menu-item">
            <span class="border"></span>
            <router-link  to="/epanel" :class="{ active: this.$route.path == '/epanel' }">
              <span class="border"></span>
          ...
          <li class="menu-item">
            <router-link to="/epanel/marketplace" :class="{ active: this.$route.path == '/epanel/marketplace' }">
              <span class="border"></span>
        ...
        <ul @click="close" class="menu">
          ...
          <li class="menu-item">
            <router-link to="/epanel/mycourses"
              :class="{ active: this.$route.path == '/epanel/mycourses' || this.$route.path == '/epanel/new_course' || this.$route.path == `/epanel/course/manager/${this.$route.params.id}` }">
              <span class="border"></span>
              <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24" fill="none"
                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
              ...
              <span>Sou Educador(a)</span>
            </router-link>
          </li>
          <li class="menu-item">

            <router-link to="/epanel/enrollments" :class="{ active: this.$route.path == '/epanel/enrollments' }">
              <span class="border"></span>
              <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24" fill="none"
                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
        ...
        <ul @click="close" class="menu">
          <div>USUÁRIOS</div>
          <li class="menu-item">
            <router-link to="/epanel/balance" :class="{ active: this.$route.path == '/epanel/balance' }">
              <span class="border"></span>
              <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24" fill="none"
                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
...
@media(max-width: 767px) {
  ...
  .sidebar-academy header {
    display: none;
  }

  .sidebar-academy .body {
    width: 100%;
  }
