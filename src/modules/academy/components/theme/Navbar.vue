<template>
  <header class="navbar-academy">
    <div class="contents">
      <div class="left">
        <div @click="openSidebar" class="burger"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
            aria-label="burger" role="presentation" fill="currentColor" style="width: 24px; height: 24px;">
            <g>
              <g>
...
import Dropdown from "../modals/Dropdown.vue";
