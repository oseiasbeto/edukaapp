<template>
    <footer class="footer">
        <div class="container">
            <div class="footer__area-1">
                <nav>
                    <div class="footer-navigation__title" data-v-2562505b="">
                        A Empresa
                    </div>
                    <ul>
                        <li>
            ...
            <div class="footer__area-2">
                ...
                <ul class="social">
                    ...
                    <li class="social-item"><a href="https://linkedin.com/edukaafrica" class="social-link">
                            <svg aria-hidden="true" focusable="false" role="img" xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 448 512">
                                <path fill="currentColor"
                    ...
                    <li class="social-item"><a href="https://pinterest.com/edukaafrica" class="social-link">
...
.container {
    ...
    margin-left: auto;
    display: grid;
    grid-gap: calc(var(16px)*4);
    grid-template-rows: auto;
    grid-template-columns: 1fr 1fr;
    grid-template-areas:
        "footer__breadcrumb footer__breadcrumb"
        "footer__area-1 footer__area-1"
        "footer__area-2 footer__area-2"
        "footer__area-3 footer__area-3";
}
...
nav ul li a {
    ...
    color: #171a2b !important;
    will-change: opacity;
    transition: opacity .25s cubic-bezier(0.4, 0, 0.14, 1);
    display: inline;
}
